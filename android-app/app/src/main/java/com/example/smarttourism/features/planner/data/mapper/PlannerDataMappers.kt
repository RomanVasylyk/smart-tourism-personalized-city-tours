...
internal fun RouteResponse.toDomain(): RoutePlan =
    RoutePlan(
        ...
        totalWaitMinutes = total_wait_minutes ?: 0,
        returnToStartMinutes = return_to_start_minutes,
        poiCount = poi_count,
        requiredPoisOverBudget = required_pois_over_budget ?: false,
        closedRequiredPoiIds = closed_required_poi_ids.orEmpty(),
        routingDegraded = routing_degraded ?: false,
...
internal fun RoutePlan.toDto(): RouteResponse =
    RouteResponse(
        ...
        poi_count = poiCount,
        required_pois_over_budget = requiredPoisOverBudget,
        closed_required_poi_ids = closedRequiredPoiIds,
