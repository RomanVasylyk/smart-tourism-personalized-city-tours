        ...
        Dialog(
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                PoiMapScreen(
                    ...
                    focusedPoi = state.selectedMapPoiForAction,
                    focusedPoiPrimaryActionLabel = state.selectedMapPoiForAction?.let { poi ->
                        stringResource(
                            if (poi.id in state.requiredPoiIds) {
                    ...
                    onFocusedPoiDismiss = actions.onDismissMapPoiAction,
                    onFocusedPoiPrimaryAction = {
                        state.selectedMapPoiForAction?.let { poi ->
                            actions.onConfirmMapPoiToggle(poi)
                        }
                    },
