...
SELECT
    ...
    COUNT(*) FILTER (WHERE rsp.visited AND NOT rsp.skipped) AS visited_count,
    ...
    AVG(CASE WHEN rsp.visited AND NOT rsp.skipped THEN 1.0 ELSE 0.0 END) AS completion_rate,
